...
namespace ocr1
{
    class OCRApi
    {
        ...
        private static string GetOrignal()
        {
            ...
            return $"a={config.appid}&b={config.bucket}&k={config.secret_id}&e={expired}&t={current}&r={GenerateNonceStr()}&u=0&f=";
        }
        ...
        {
            var hmacsha1 = new HMACSHA1(Encoding.UTF8.GetBytes(config.secret_key));
